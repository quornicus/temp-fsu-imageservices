...
FilesystemCache.pathname = /usr/local/cantaloupe/cache
...
# automatically.
HeapCache.persist.filesystem.pathname = /usr/local/cantaloupe/heap.cache
...
log.access.FileAppender.pathname = /usr/local/tomcat/logs/cantaloupe/access-cantaloupe.log
